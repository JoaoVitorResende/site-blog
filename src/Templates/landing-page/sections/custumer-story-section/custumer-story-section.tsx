                ...
                <div className="grid gap-8 md:grid-cols-2">
                    {customerStories.map((customerStories) => (
                        <div key={customerStories.author.name} className="flex flex-col gap-6 rounded-lg bg-gray-500 p-6 md:p-12">
                            <p className="text-balance text-gray-200">{customerStories.content}</p>
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    <strong className="text-gray-200 text-sm">{customerStories.author.role}</strong>
                                    <span className="text-xs text-gray-300">{customerStories.author.role}</span>
                                </div>
                            </div>
                        </div>
                    ))}
