...
export const SuportSection = () => {
    return (
        <section className="relative pb-8 md:py-10 bg-gray-700">
            ...
            <div className="absolute inset-0 hidden md:block bg-[url('/backgroundFeatures.svg')] bg-cover bg-center bg-no-repeat opacity-90" />
            <div className="container flex flex-col items-center gap-12 relative">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
                        ...
                        <p className="text-body-sm text-gray-200">Adicione a sua logo, faviconm cores no seu catalago e tenha tudo coma sua cara.</p>
                    </div>
                    ...
                    <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
                        ...
                        <p className="text-body-sm text-gray-200">Nao importa a loja, o Site.set permite que voce insira qualquer linkde afiliaddo</p>
                    </div>
